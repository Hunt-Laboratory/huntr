...
#'   \item{mat1-mat11}{Responses to ICAR matrix reasoning questions. Values are capital letters A through F corresponding to image-based response options.}
#'   \item{matrix}{Number of correct responses (out of 11) on the ICAR matrix reasoning questions.}
